<div class="bg-white flex flex-col rounded-lg shadow-lg overflow-hidden mt-2">
    <div class="flex-shrink-0 shadow-sm">
        <img src="{{asset($article->image_path)}}" alt="" loading="lazy" class="h-48 w-full object-cover" />
    </div>
    ...
    <div class="author flex items-center mt-6">
        <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-full" src="{{asset($article->user->avatar())}}" alt="" />
        </div>
        <div class="flex justify-between items-center w-full">
            ...
            <div class="text-pink-300 mr-6 flex items-center">
                <button type="submit" class="text-sm flex items-center">
                    <span class="mr-1 text-base">{{$article->comments->count()}}</span>
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" class="w-6 h-6 font-normal">
                        <path
