...
<div class="container-users">
    ...
    <div class="flex flex-col container mt-3 mb-12">
        <h1 class="mb-2 text-gray-600 text-xl">Manage stories</h1>
        <div
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap">
                                <div class="text-sm leading-5 text-gray-900">
                                    {{$story->created_at->toFormattedDateString()}}
                                </div>
                            </td>
                            ...
                            @can('manage_users')
                                ...
                                >
                                <a href="{{route('admin.stories.show',$story->id)}}" class="mr-2">
                                    ...
                                    <a href="{{route('admin.stories.edit',$story->id)}}" class="mr-2">
                                        <svg
                                            fill="none"
                                            stroke="currentColor"
                                    ...
                                    <div href="{{route('admin.stories.destroy',$story->id)}}">
